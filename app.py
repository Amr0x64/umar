...
# print(answer)
# Создаем парсер
# parser = QuizParser("""[{"question": "В ись от эпидемии чумы. Назовите это растение.", "answer": "Санкт-Петербург", "incorrect": ["Лук", "Базилик"]},
#                     {"question": "В одном из эпизодов игры 'Что? Где? Когда?' был задан вопрос о том, какое растение, согласно легенде, помогло жителям города спастись от эпидемии чумы. Назовите это растение.", "answer": "Рысь", "incorrect": ["Лк", "Базилик"]}]""")
